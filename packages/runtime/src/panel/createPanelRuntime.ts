import { createRuntime, type RuntimeDeps, type Runtime } from "../setup/createRuntime.js";
...
export function createPanelApi(bootstrapRuntime: Runtime, config: PanelApiConfig) {
