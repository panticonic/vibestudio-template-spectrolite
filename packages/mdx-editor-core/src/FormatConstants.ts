// vendored from @mdxeditor/editor v3.55.0 src/FormatConstants.ts — MIT © Petyo Ivanov

/** @internal */
export const DEFAULT_FORMAT = 0b0 as const
/** @internal */
...
/**
 * A bitfield value describing the active text formatting flags of a lexical text node.
 * @internal
 */
export type FORMAT =
