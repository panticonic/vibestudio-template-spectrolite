// vendored from @mdxeditor/editor v3.55.0 src/utils/mergeStyleAttributes.ts — MIT © Petyo Ivanov

/**
 * Merges two CSS style attribute strings into one, giving priority to `style2`.
 */
